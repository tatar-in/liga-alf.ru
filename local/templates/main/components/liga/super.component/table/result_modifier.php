...
else
{
	...
	$arSelect = array("ID", "IBLOCK_ID", "NAME", "DETAIL_PAGE_URL", "PROPERTY_STAGE",
		"PROPERTY_TEAM_1", "PROPERTY_TEAM_1.NAME", "PROPERTY_TEAM_1.PREVIEW_PICTURE", "PROPERTY_GOALS_TEAM_1", "PROPERTY_AUTO_GOALS_TEAM_1", "PROPERTY_STRUCTURE_TEAM_1", "PROPERTY_TEAM_1.DETAIL_PAGE_URL", "PROPERTY_TECHNICAL_DEFEAT_TEAM_1",
		"PROPERTY_TEAM_2", "PROPERTY_TEAM_2.NAME", "PROPERTY_TEAM_2.PREVIEW_PICTURE", "PROPERTY_GOALS_TEAM_2", "PROPERTY_AUTO_GOALS_TEAM_2", "PROPERTY_STRUCTURE_TEAM_2", "PROPERTY_TEAM_2.DETAIL_PAGE_URL", "PROPERTY_TECHNICAL_DEFEAT_TEAM_2");
	...
	while ($arEl = $rsEl->GetNext())
	{
		...
		elseif(($arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_1_VALUE"]=="0" || $arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_1_VALUE"]>0) && 
				($arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_2_VALUE"]=="0" || $arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_2_VALUE"]>0)){
			$arResult["MATCHES"][$arEl["ID"]]["GOALS_1"] = $arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_1_VALUE"];
			$arResult["MATCHES"][$arEl["ID"]]["GOALS_2"] = $arEl["PROPERTY_TECHNICAL_DEFEAT_TEAM_2_VALUE"];
		}
